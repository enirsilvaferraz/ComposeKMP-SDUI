...
class UILazyListScope(val scope: LazyListScope, val screen: SDUIScreenScope) : UIScope("ui-lazy-list-scope")
class UIRowScope(val scope: RowScope, val screen: SDUIScreenScope) : UIScope("ui-row-scope")